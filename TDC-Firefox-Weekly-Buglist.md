...
- **_Quality of Experience_**
  - **Done**
      ...
      - [Bug 1271536](https://bugzilla.mozilla.org/show_bug.cgi?id=1271536) - gfxDWriteFontEntry::CopyFontTable() produce different CMAP table for FirefoxEmoji.ttf when loaded as a bundle or remotely - **_Tim Chien_**
  ...
  - **Next**  
      ...
      - [Bug 1270878](https://bugzilla.mozilla.org/show_bug.cgi?id=1270878) - Assertion failure at gfx/thebes/gfxDWriteFontList.cpp:1730 on Windows 8 debug - **_Tim Chien_**
...
- **_Notification_**
  - **Next**
      - [Bug 1193006](https://bugzilla.mozilla.org/show_bug.cgi?id=1193006) - Show icons next to non-default permissions in the Permissions section of the Control Center
