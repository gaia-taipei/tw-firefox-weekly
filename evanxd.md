...
* [Settings Bugs]
  ...
  - [Bug 1170236](http://bugzil.la/1170236) - Sometimes the screen to connect to a hidden network doesn't have the OK button enabled
    - Updated patch: https://github.com/evanxd/gaia/commit/a37a7cb57f9fb4135edfa9f5e5e7640364812eb2

* [BLE Test App]
  - Has a meeting for the implementation of bt test app.
    - https://taiwan.etherpad.mozilla.org/1313

* [Add-ons Hackathon]
  - Win the Best Design in the Hackathon
    - A Firefox OS add-on that helps users use and configure their phone easier and faster.
    - https://github.com/evanxd/robot-jan

### This week
* [Audio Channel Management]
  - [Bug 1180618](http://bugzil.la/1180618) - Ringer is not managed by Audio Channel Service
  - [Bug 1198165](http://bugzil.la/1198165) - [AudioChannel]Play a song, then play a video, and drap the progress bar, the music will continue playing.
  - [Bug 1199605](http://bugzil.la/1199605) - The sound manager doesn't work correctly if we kill a playing music app
    - Add tests.
  - Discuss issues with Alastor and baku.
  - Have meetings for MediaSession API.
